...
var whichIndex = []whichEntry{
	{Command: "history", Description: "Query past cyclone bulletin issuances that PAGASA only serves as the latest.", Group: "Local state that compounds", WhyItMatters: "Agents can answer 'how has this storm evolved' without PAGASA retaining history."},
	{Command: "drift", Description: "Show how a city forecast changed between issuances.", Group: "Local state that compounds", WhyItMatters: "Reveals whether a forecast is stabilizing or swinging."},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  pagasa-pp-cli which "stale tickets"
  pagasa-pp-cli which "bottleneck"
  pagasa-pp-cli which --limit 1 "send message"
  pagasa-pp-cli which                                # list the full capability index`,
