...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("PAGASA_STATE_DIR", "")
	t.Setenv("PAGASA_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"pagasa-pp-cli auth login",
		"pagasa-pp-cli doctor",
		"pagasa-pp-cli help items",
		"pagasa-pp-cli sync",
		"pagasa-pp-cli profile list",
		"pagasa-pp-cli feedback list",
		"pagasa-pp-cli which",
		"pagasa-pp-cli agent-context",
		"pagasa-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"pagasa-pp-cli teach",
		"pagasa-pp-cli recall",
		"pagasa-pp-cli learnings",
		"pagasa-pp-cli teach-pattern",
		"pagasa-pp-cli teach-lookup",
		"pagasa-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("pagasa-pp-cli")); err == nil {
